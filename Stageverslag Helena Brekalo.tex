...
\label{sprint1}
Deze kan gevonden worden in de annex. \todo{anders verwoorden?}\\
\paragraph{Enqu\^ete} \todo{wegdoen denk ik}
De enqu\^ete en de resultatentabel zijn ook te vinden in de annex. \todo{referentie ernaar}
