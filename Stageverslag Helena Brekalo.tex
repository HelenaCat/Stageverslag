...
De stage heeft enorm veel geleerd over het samenwerken in grote groepen en over het (grotendeels) zelfstandig uitwerken van projecten. Doordat het project individueel werd gerealiseerd, werden alle aspecten zelfstandig\todo{beter verwoorden} uitgewerkt en was het enorm leerzaam doordat er in bestaande code moest ingewerkt worden (en deze dus helemaal begrepen moest worden) en de doelen voor het project zelfstandig behaald moesten worden, waar dit tijdens de opleiding in groepen gebeurt.\todo{aanvullen}
...
\label{ppt}
\includepdf[pages=-,nup=2x2]{demopresentation.pdf}
