...
De stage heeft enorm veel geleerd over het samenwerken in grote groepen en over het (grotendeels) zelfstandig uitwerken van projecten. Doordat het project individueel werd gerealiseerd, werden alle aspecten zelfstandig\todo{beter verwoorden} uitgewerkt. Er moest in bestaande code ingewerkt worden en de doelen voor het project moesten ook individueel behaald worden, waar dit tijdens de opleiding Informatica in groep gebeurt.\todo{aanvullen}
